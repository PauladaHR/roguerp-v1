...
vSERVER = Tunnel.getInterface("vrp_taxi")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
...
local initService = { 900.1,-171.16,74.08 }
-----------------------------------------------------------------------------------------------------------------------------------------
-- STOPVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
local stopVehicle = {
					...
					if serviceStatus then
						if vSERVER.initService(false) then
							...
							if currentPassenger ~= nil then
								TriggerServerEvent("tryDeleteEntity",PedToNet(currentPassenger))
								currentPassenger = nil
							end

							if lastPassenger ~= nil then
								TriggerServerEvent("tryDeleteEntity",lastPassenger)
								lastPassenger = nil
							end
						end
					else
