$(document).ready(function(){
	...
	document.onkeyup = data => {
		if (data["key"] === "Escape"){
			$.post("http://vrp_inspect/invClose");
			$(".invRight").html("");
			$(".invLeft").html("");
		}
	};
	...
	$('.empty').droppable({
		...
		drop: function(event,ui){
			...
			if (origin === "invLeft" && tInv === "invLeft"){
				...
				$.post("http://vrp_inspect/updateChest",JSON.stringify({
					item: itemData.key,
					slot: itemData.slot,
					target: target,
					amount: parseInt(amount)
