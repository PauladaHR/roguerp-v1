...
local garageLocates = {
	...
	["38"] = { name = "Bicicletário", payment = true },
	...
	["50"] = { name = "Garagem", payment = true },
	["51"] = { name = "Garagem", payment = true },
	["52"] = { name = "Garagem", payment = true },
	["53"] = { name = "Garagem", payment = true },
	...
	["68"] = { name = "Garagem", payment = true },
	["69"] = { name = "Garagem", payment = true },
	["70"] = { name = "Garagem", payment = true }, 
	["71"] = { name = "Arma02", payment = true }, 
	["72"] = { name = "Municao02", payment = true }, 
