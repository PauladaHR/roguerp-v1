    ...
    $.post("http://vrp_crafting/requestCrafting", JSON.stringify({ craft: selectCraft }), (data) => {
        ...
        for (let x = 1; x <= 72; x++) {
            ...
            if (data.inventoryUser[slot] !== undefined) {
                ...
                const item = `<div class="item populated" style="background-image: url('nui://vrp_inventory/web-side/images/armas/${v["index"]}.png'),
                ...
                url('nui://vrp_inventory/web-side/images/weapons/${v["index"]}.png'); background-position: center; background-repeat: no-repeat;" data-item-key="${v.key}" data-name-key="${v.name}" data-amount="${v.amount}" data-slot="${slot}">
        ...
        for (let x = 1; x <= 30; x++) {
            ...
            if (nameList2[x - 1] !== undefined) {
                ...
                const item = `<div class="item populated" title="" style="background-image: url('nui://vrp_inventory/web-side/images/armas/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/comidas/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/geral/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/hospital/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/ilegal/${v["index"]}.png'),
                ...
                url('nui://vrp_inventory/web-side/images/premium/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/veiculos/${v["index"]}.png'),
                url('nui://vrp_inventory/web-side/images/weapons/${v["index"]}.png'); background-position: center; background-repeat: no-repeat;" data-item-key="${v.key}" data-name-key="${v.name}" data-list="${list}" data-slot="${slot}" data-description="${v["desc"]}">
