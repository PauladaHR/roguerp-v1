vehicleCustomisationPrices = {
	cosmetics = 100,
	respray = 100,
	engines = { 1, 1000, 2000, 3000, 4000, 5000 },
	brakes = { 1, 1000, 2000, 3000, 4000, 5000 },
	transmission = { 1, 1000, 2000, 3000, 4000, 5000 },
	suspension = { 1, 1000, 2000, 3000, 4000, 5000 },
	shield = { 1, 10000, 15000, 20000, 25000, 30000 },
	turbo = 5000,
	wheels = 100,
	customwheels = 100,
	wheelsmoke = 100,
