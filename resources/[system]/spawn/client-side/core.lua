...
function Barber(ped,data)
	if data ~= nil then
        SetPedHeadBlendData(ped,data.fathersID or 0,data.mothersID or 0,0,data.skinColor or 0,0,0,F(data.shapeMix or 0),0,0,false)

        SetPedEyeColor(ped,data.eyesColor or 0)
        SetPedFaceFeature(ped,6,data.eyebrowsHeight or 0)
        SetPedFaceFeature(ped,7,data.eyebrowsWidth or 0)
        -- Nariz
        SetPedFaceFeature(ped,0,data.noseWidth or 0)
        SetPedFaceFeature(ped,1,data.noseHeight or 0)
        SetPedFaceFeature(ped,2,data.noseLength or 0)
        SetPedFaceFeature(ped,3,data.noseBridge or 0)
        SetPedFaceFeature(ped,4,data.noseTip or 0)
        SetPedFaceFeature(ped,5,data.noseShift or 0)
        -- Bochechas
        SetPedFaceFeature(ped,8,data.cheekboneHeight or 0)
        SetPedFaceFeature(ped,9,data.cheekboneWidth or 0)
        SetPedFaceFeature(ped,10,data.cheeksWidth or 0)
        -- Boca/Mandibula
        SetPedFaceFeature(ped,12,data.lips or 0)
        SetPedFaceFeature(ped,13,data.jawWidth or 0)
        SetPedFaceFeature(ped,14,data.jawHeight or 0)
        -- Queixo
        SetPedFaceFeature(ped,15,data.chinLength or 0)
        SetPedFaceFeature(ped,16,data.chinPosition or 0)
        SetPedFaceFeature(ped,17,data.chinWidth or 0)
        SetPedFaceFeature(ped,18,data.chinShape or 0)
        -- Pescoço
        SetPedFaceFeature(ped,19,data.neckWidth or 0)
        ...
        -- Sobracelha 
        SetPedHeadOverlay(ped,2,data.eyebrowsModel or 0,data.eyebrowsIntensity or 0)
        SetPedHeadOverlayColor(ped,2,1,data.eyebrowsColor or 0,data.eyebrowsColor or 0)
        -- Barba
        SetPedHeadOverlay(ped,1,data.beardModel or 0,data.beardIntensity or 0)
        SetPedHeadOverlayColor(ped,1,1,data.beardColor or 0,data.beardColor or 0)
        -- Pelo Corporal
        SetPedHeadOverlay(ped,10,data.chestModel or 0,0.99)
        SetPedHeadOverlayColor(ped,10,1,data.chestColor or 0,data.chestColor or 0)
        -- Blush
        SetPedHeadOverlay(ped,5,data.blushModel or -1,0.99)
        SetPedHeadOverlayColor(ped,5,2,data.blushColor or 0,data.blushColor or 0)
        -- Battom
        SetPedHeadOverlay(ped,8,data.lipstickModel or -1,0.99)
        SetPedHeadOverlayColor(ped,8,2,data.lipstickColor or 0,data.lipstickColor or 0)
        -- Manchas
        SetPedHeadOverlay(ped,0,data.blemishesModel or -1,0.99)
        SetPedHeadOverlayColor(ped,0,0,0,0)
        -- Envelhecimento
        SetPedHeadOverlay(ped,3,data.ageingModel or-1,0.99)
        SetPedHeadOverlayColor(ped,3,0,0,0)
        -- Aspecto
        SetPedHeadOverlay(ped,6,data.complexionModel or -1,0.99)
        SetPedHeadOverlayColor(ped,6,0,0,0)
        -- Pele
        SetPedHeadOverlay(ped,7,data.sundamageModel or -1,0.99)
        SetPedHeadOverlayColor(ped,7,0,0,0)
        -- Sardas
        SetPedHeadOverlay(ped,9,data.frecklesModel or -1,0.99)
        SetPedHeadOverlayColor(ped,9,0,0,0)
        -- Maquiagem
        SetPedHeadOverlay(ped,4,data.makeupModel or -1,0.99)
