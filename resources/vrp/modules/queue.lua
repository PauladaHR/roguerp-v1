...
Config.Language = {
	...
	steam = "Você precisa estar com a Steam e Discord aberto para conectar."
}
...
Citizen.CreateThread(function()
	local function playerConnect(name,setKickReason,deferrals)
		...
		if not Queue:IsDiscordRunning(src) then -- if Config.RequireSteam and not Queue:IsSteamRunning(src) then
			done(Config.Language.steam)
			CancelEvent()
			return
		end
